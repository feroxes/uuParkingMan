...
const logger = LoggerFactory.get("ParkingmanMainAbl");

class ParkingmanMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuParkingman",
        typeCode: "uu-parkingman-maing01",
        location: location,
...
module.exports = new ParkingmanMainAbl();
